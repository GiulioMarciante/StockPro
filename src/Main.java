...
//        Warehouse.searchForPurchasePrice(500).forEach(System.out::println);
//        Warehouse.searchForSalesPrice(500).forEach(System.out::println);
//        Warehouse.searchForRange(500,1000).forEach(System.out::println);
